...
func _build_controls() -> void:
	...
	brake_button.set_anchors_preset(Control.PRESET_LEFT_BOTTOM)
	...
	gas_button.set_anchors_preset(Control.PRESET_RIGHT_BOTTOM)
	...
	pause_button.set_anchors_preset(Control.PRESET_RIGHT_TOP)
